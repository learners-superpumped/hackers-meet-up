...
export function SurveyQuestionItem({question, ...props}: SurveyQuestionItemProps) {
    ...
    return <div{...props}>
        <div className={classNames('w-[860px]', 'text-start', 'flex', 'flex-col')}>
            ...
            <input
                ...
                onKeyDown={(event) => {
                    // Enter 입력시 setAnswer
                    if (event.keyCode === 13 && answer) props.onAnswer(question, answer)
                }}
            ...
            <div
                onClick={() => answer && props.onAnswer(question, answer)}
